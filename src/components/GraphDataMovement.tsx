...
import DATA_DZ_LOGO_ICON from "../assets/img/data_dz_logo_icon.png";
...
export function GraphDataMovement({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "relative flex w-full items-center justify-center rounded-lg  bg-background  sm ",
        className
      )}
      ref={containerRef}
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16">
            {/* <Icons.openai /> */}
            <img src={DATA_DZ_LOGO_ICON} alt="Data DZ" className="h-10" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}>
